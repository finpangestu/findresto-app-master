    ...
    render() {
        ...
        <nav class="navdeks">
            <div class="header-logo">
                <a href=""><img src="./images/heros/full-logo-white.png" alt="findresto-logo"></a>
            </div>
            <div class="menu">
                <a href=""><i class="fa-solid fa-house"></i>Home</a>
                <a href="#/favorite"><i class="fa-solid fa-heart"></i>Favorit</a>
                <a href="https://www.linkedin.com/in/finnn-941642241/"><i class="fa-solid fa-user"></i>Owner</a>
            </div>
        </nav>
